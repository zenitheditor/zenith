...
pub(super) struct AddAssetSpec<'a> {
    ...
    pub(super) producer_kind: Option<&'a str>,
    pub(super) producer_source: Option<&'a str>,
...
pub(super) fn apply_add_asset(
    ...
    doc.assets.assets.push(AssetDecl {
        ...
        producer_kind: spec.producer_kind.map(str::to_owned),
        producer_source: spec.producer_source.map(str::to_owned),
